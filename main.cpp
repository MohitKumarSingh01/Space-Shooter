...
void introScreen()
{
	glClear(GL_COLOR_BUFFER_BIT);
		...
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-425, 490, 0.0,"CHANDIGARH UNIVERSITY");
	...
	displayRasterText(-100, 150, 0.0,"created by");
	 ...
	 displayRasterText(-130, 80, 0.0,"SHOOTERS");
	  ...
	  displayRasterText(-800, -100, 0.0," STUDENT NAMES");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0," Mohit Kumar Singh");
	//displayRasterText(-800, -285, 0.0,"");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Under the Guidance of");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Prof Manni Kumar");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-250, -400, 0.0,"Academic Year 2022-2026");
        glColor3f(1.0, 1.0, 1.0);
